...
public class Text {
    ...
    private static final String TEXT_RUS = "В одном селе, возле Блудова болота, в районе города Переславль-Залесского, осиротели двое детей. Их мать умерла от болезни, отец погиб на Отечественной войне." +
            ...
            "Очень хорошо, что Настя постарше брата на два года, а то бы он непременно зазнался и в дружбе у них не было бы, как теперь, прекрасного равенства. Бывает, и теперь Митраша вспомнит, как отец наставлял его мать, и вздумает, подражая отцу, тоже учить свою сестру Настю. ";
